...
export const metadata: Metadata = {
  title: "Política de Privacidad | AtlanPool",
  robots: {
    index: false,
    follow: true,
  },
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-24 md:py-32 max-w-4xl">
        ...
        <div className="prose prose-sm md:prose-base dark:prose-invert max-w-none">
          ...
          <p>
            <strong>AtlanPool</strong>, como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente Política de Privacidad.
          </p>
          ...
          <h3>6. DERECHOS</h3>
          <p>
            Usted tiene derecho a obtener confirmación sobre si en AtlanPool estamos tratando sus datos personales por tanto tiene derecho a acceder a sus datos personales, rectificar los datos inexactos o solicitar su supresión cuando los datos ya no sean necesarios.
          </p>
          <p>
            Puede ejercer sus derechos dirigiendo una comunicación a la dirección de correo: <a href="mailto:info@atlanpool.es">info@atlanpool.es</a>.
          </p>
        </div>
      </main>
      <Footer />
