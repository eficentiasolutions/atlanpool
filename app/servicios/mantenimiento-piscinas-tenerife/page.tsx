...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Mantenimiento de Piscinas en Tenerife | AtlanPool — Cientos de Clientes",
    description: "Servicio profesional de mantenimiento de piscinas en Tenerife. Recupera tu tiempo libre. Primera revisión GRATIS. cientos de clientes satisfechos.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Mantenimiento de Piscinas en Tenerife | AtlanPool",
      },
    ],
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "Mantenimiento de Piscinas en Tenerife",
      item: "https://www.atlanpool.es/servicios/mantenimiento-piscinas-tenerife",
    },
  ],
};
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "El precio del mantenimiento de piscinas en Tenerife depende del tamaño de la piscina, el tipo de tratamiento (cloro o sal) y la frecuencia de las visitas. En AtlanPool nuestros planes empiezan desde 60€ por visita individual. Ofrecemos una primera revisión de balance químico completamente gratuita para evaluar el estado de tu piscina y recomendarte el plan más adecuado sin compromiso.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "El servicio de mantenimiento de AtlanPool incluye: limpieza completa de fondo y paredes con aspiradora profesional, vaciado y limpieza de skimmers y cestillos, balance químico completo (pH, cloro, alcalinidad total y dureza), limpieza de prefiltros y cestas del filtro, revisión del sistema de circulación y bomba, comprobación de presión del filtro, limpieza de bordes y línea de agua, y un informe digital tras cada visita con el estado detallado de tu piscina.",
      },
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Si tu piscina se ha puesto verde, significa que hay un desequilibrio en el balance químico y proliferación de algas. Es importante actuar rápido porque cuanto más tiempo pase, más difícil y costosa será la recuperación. En AtlanPool ofrecemos un servicio de recuperación de agua verde con resultado garantizado. Aplicamos un tratamiento de choque profesional que elimina algas y bacterias, y devolvemos tu piscina a un estado cristalino. Si ya eres cliente de mantenimiento, este servicio está incluido en tu plan.",
      },
    },
    {
      "@type": "Question",
                ...
                <div className="mb-8 md:mb-12">
                  <div className="inline-block bg-white/90 backdrop-blur-md rounded-2xl px-5 py-4 md:px-8 md:py-6 border border-brand-primary/10 shadow-2xl">
                    ...
                    <p className="text-brand-primary/80 text-sm mt-2 font-medium">
                      Recupera 80 horas al año y disfruta de una piscina cristalina sin preocupaciones. Más de cientos de familias ya confían en nosotros.
                    </p>
                  </div>
                </div>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  ¿Por qué elegir AtlanPool para el <span className="gradient-text">mantenimiento de tu piscina</span>?
                </h2>
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Más de cientos de familias en Tenerife confían en nosotros para mantener sus piscinas en perfectas condiciones todo el año
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="bg-card rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-xl font-bold mb-3">Cientos de Clientes Satisfechos</h3>
                  <p className="text-muted-foreground">
                    Más de cientos de familias en toda Tenerife confían en nuestro servicio. Valoración media de 5.0 estrellas en Google Reviews.
                  </p>
                </div>
                ...
                {[
                  {
                    ...
                    a: "El precio del mantenimiento de piscinas en Tenerife depende del tamaño de la piscina, el tipo de tratamiento (cloro o sal) y la frecuencia de las visitas. En AtlanPool nuestros planes empiezan desde 60€ por visita individual. Ofrecemos una primera revisión de balance químico completamente gratuita para evaluar el estado de tu piscina y recomendarte el plan más adecuado sin compromiso.",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    a: "Significa que hay un desequilibrio químico y proliferación de algas. Es importante actuar rápido. En AtlanPool ofrecemos un servicio de recuperación de agua verde con resultado garantizado. Aplicamos un tratamiento de choque profesional que elimina algas y bacterias. Si ya eres cliente de mantenimiento, este servicio está incluido.",
                  },
                  {
