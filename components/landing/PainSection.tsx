...
const PainSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="py-12 md:py-20 lg:py-28 bg-slate-100 relative overflow-hidden"
    >
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm md:text-lg max-w-2xl mx-auto px-2">
            Si alguno de estos problemas te resulta familiar, no estás solo. Como especialistas en mantenimiento de piscinas en Santa Cruz de Tenerife, lo vemos todos los días.
          </p>
        </motion.div>
