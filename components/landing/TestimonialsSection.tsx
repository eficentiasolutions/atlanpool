                      ...
                      return (
                        ...
                        >
                          ...
                          {testimonial.isGoogleReview && (
                            <div className="absolute -top-1.5 -right-1.5 w-8 h-8 md:w-9 md:h-9 bg-white rounded-full flex items-center justify-center shadow-md border border-gray-100 z-10 overflow-hidden">
                              <svg className="w-5 h-5 md:w-5.5 md:h-5.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
