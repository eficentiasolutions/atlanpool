    ...
    <section ref={ref} className="py-12 md:py-20 lg:py-28 bg-muted overflow-hidden relative" id="contacto">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 md:gap-6">
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs md:text-base">
                    <a href="mailto:info@atlanpool.es" className="hover:text-secondary transition-colors">info@atlanpool.es</a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs md:text-base">Lun - Vie: 8:00 - 19:00</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form
              action="https://formsubmit.co/info@atlanpool.es"
              method="POST"
            ...
            >
              ...
              <input type="hidden" name="_subject" value={`Nuevo contacto desde AtlanPool ${selectedPlan ? `- Interesado en ${selectedPlan}` : ''}`} />
